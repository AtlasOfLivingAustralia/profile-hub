            ...
            <div class="col-sm-12">
                ...
                <ul>
                    <li ng-repeat="approvedList in opusCtrl.opus.approvedLists">
                        <a href="${grailsApplication.config.getProperty('lists.ui.url')}/speciesListItem/list/{{approvedList}}">{{(opusCtrl.allSpeciesLists | filter: approvedList)[0].listName | default:'Loading...'}}</a>
