        ...
        <div class="row">
            <div class="col-sm-4 col-xs-12">
                ...
                <g:if test="${opus.keybaseProjectId != null}">
                    <g:link uri="/opus/${opus.shortName ?: opus.uuid}/identify" class="btn btn-outline-secondary btn-lg btn-block " tooltip="${opus.opusLayoutConfig.helpTextIdentify}" tooltip-placement="right" tooltip-append-to-body="true">Identify</g:link>
                </g:if>
