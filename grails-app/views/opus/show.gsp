    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-xs-12">
                ...
                <g:link uri="/opus/${opus.shortName ?: opus.uuid}/documents" class="btn btn-default btn-lg btn-block" tooltip="${opus.opusLayoutConfig.helpTextDocuments}" tooltip-placement="right" tooltip-append-to-body="true">Library</g:link>
            </div>  <!-- /col-sm-4 -->
